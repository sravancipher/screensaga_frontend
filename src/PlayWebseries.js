...
function PlayWebseries({stopplayingmovie,image,name}){
    ...
    return(
        ...
        <>
          ...
          <div >
          <img src={image} style={{width:"100%",height:"100vh",position:"absolute",top:"0px"}}></img>
          <div style={{background:"linear-gradient(to left,rgba(255, 126, 95, 0),rgba(0, 0, 0, 0.7), black)",width:"100%",height:"100vh",position:"absolute",top:"0px"}}></div>
          <div className="row" style={{position:"absolute",top:"50%",width:"100%"}}>
