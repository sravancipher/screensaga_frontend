        ...
        <div className="container-fluid ">
          ...
          <div className="collapse navbar-collapse" id="mynavbar">
            ...
            <form >
              ...
              {input?<h5 class="mt-2 text-success" style={{textAlign:"center",position:"absolute",zIndex:"2"}}>{opdata}</h5>:<h5 class="mt-2 text-danger" style={{textAlign:"center",position:"absolute",zIndex:"2"}}>{opdata}</h5>}
            </form>
          </div>
        </div>
      </nav>
